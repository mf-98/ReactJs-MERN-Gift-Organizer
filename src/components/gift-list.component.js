...
const Gift = props => (
    <tr>
        <td>{props.gift.friendname}</td>
        <td>{props.gift.description}</td>
        <td>{props.gift.budget}</td>
        <td>{props.gift.dateBought.substring(0,10)}</td>
        <td>
            <Link to={"/edit/"+props.gift._id}>edit</Link> | <a href="#" onClick={() => {props.deleteGift(props.gift._id)}}>delete</a>
        </td>
    </tr>
)
